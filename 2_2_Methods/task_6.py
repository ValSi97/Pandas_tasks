...
В столбце 'product_price' замените цену на товар в виде числа XXXX, на строку в виде 'XXXX руб'
...
df['product_price'] = df['product_price'].map(lambda x: True if x == 'куплено' else False, na_action='ignore')
print(df)
