...
Импортируйте данные из файла и присвойте столбцу 'city' тип данных 'category', столбцу 'col_2' - 'string',
а 'col_3' - 'int'. Столбец 'date' установите в качестве индексов строк.
